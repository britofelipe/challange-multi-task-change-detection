...
def generate_final_submission(test_preds, train_preds, X_test, y_train):
    ...
    weights = [0.4, 0.3, 0.3]  # Weights for XGBoost, LightGBM, CatBoost
    ...
    print(f"\n🎯 Final Ensemble Train Macro F1 Score: {f1_macro:.4f}")
    print(f"🎯 Final Ensemble Train Weighted F1 Score: {f1_weighted:.4f}")

    # Save final test submission
    filename_test = f"submission_ENSEMBLE_{TIMESTAMP}.csv"
